...
|:------------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.2.2 | 2026-06-10 | [79652](https://github.com/airbytehq/airbyte/pull/79652) | Validate and normalize `account_id` config: add `pattern` constraint (digits only) and `.strip()` whitespace in all path templates to prevent malformed URLs |
