...
|:-----------|:-----------|:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.2.14 | 2026-06-11 | [XXXXX](https://github.com/airbytehq/airbyte/pull/XXXXX) | Fixed JSON serialization failures caused by circular references in Facebook SDK export data for ad_sets and other streams. |
